...
#define ESP_PANEL_LCD_RGB_HBP (30)            //(8)
#define ESP_PANEL_LCD_RGB_HFP (210)           //(8)
#define ESP_PANEL_LCD_RGB_VPW (4)             //(4)
#define ESP_PANEL_LCD_RGB_VBP (4)             //(16)
#define ESP_PANEL_LCD_RGB_VFP (4)             //(16)
